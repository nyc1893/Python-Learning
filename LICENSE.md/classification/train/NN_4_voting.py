...
# -*- coding: utf-8 -*-
"""
NN train and test without separate PMU
"""
...
for dense_layer in dense_layers:
    for layer_size in layer_sizes:
                    ...
                    """                  
                    #loading training set
                    pickle_in = open("/Users/imanniazazari/Desktop/DOE project/X_train_6_rocof_test.pickle","rb")
                    X_test = pickle.load(pickle_in)
                    
                    num_pmu=X_test.shape[1]
                    
                    pickle_in = open("/Users/imanniazazari/Desktop/DOE project/y_train_6_rocof_test.pickle","rb")
