...
def get_sno_label():
    ...
    tt['semi-DT'] = semi['semi-DT'].values
    tt['semi-GBDT'] = semi['semi-GBDT'].values
    tt['semi-SVC'] = semi['semi-DT'].values
    tt['semi-LR'] = semi['semi-GBDT'].values
    tt['semi-KNN'] = semi['semi-DT'].values
