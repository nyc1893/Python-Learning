...
def deal(df,fname,path2):
    ...
    for i_PMU in range(n_PMU):
        ...
        # if n != 0:
            ...
            df2 = subset_df.reset_index()['df'].iloc[start:n].interpolate(method='polynomial', order=2)
            ...
            # print(v_utc)
            filter_input = dt # you can change the input, I suggest you use di_pm or ROCOF
