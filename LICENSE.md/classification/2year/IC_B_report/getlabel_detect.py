...
def run():
    ...
    test_x = datapick2.eve_top2()  
    # test_x.to_csv("test_x.csv",index = 0)
    a1 = test_x.pop("label").values
    a2 = test_x.pop("new").values
    a3 = test_x.pop("zeta_v").values
    a4 = test_x.pop("zeta_r").values    
    ...
    if train == 1:
        ...
        te["zeta_v"] = a3
        te["zeta_r"] = a4
        te.to_csv("eve_3.csv",index = None)
