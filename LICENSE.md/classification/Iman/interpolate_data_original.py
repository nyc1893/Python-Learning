...
with os.scandir('/Volumes/Iman/IBM data/Events/B/Original/8 weeks-1/') as entries:
    ...
    ## loading datasets
        filename='/Volumes/Iman/IBM data/Events/B/Original/8 weeks-1/'+str(event_name_full)
    
        df=pq.read_table(filename).to_pandas()
        
        PMU_list = pd.read_excel('/Volumes/Iman/IBM data/Code/PMU_reporting_rate.xlsx', sheet_name='Sheet1')
