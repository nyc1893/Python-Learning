...
def get_result(q1,q2,d1,d2,turb,i,word,path):
...
test = pd.read_csv('../data/pp'+str(turb)+'12_'+str(year+2)+'.csv')	
turb = 'ge'
test2 = pd.read_csv('../data/pp'+str(turb)+'12_'+str(year+2)+'.csv')
...
yall = test['l0']
df_ramp = test[(test['dif']>300.5/20 )&( test['dif']<300.5/10 )]
ind = df_ramp.index
print(df_ramp.head())
...
i = 1	
word = 'a'
path = 'gene2/winner_mit'

yhat,idx2 = get_result(q1,q2,d1,d2,turb,i,word,path)
q1= 70
q2= 99
d1 = 735
d2 = 200
i = 1	
word = 'a'
path = 'gene3/winner_ge'


turb = 'ge'
yhat2,_ = get_result(q1,q2,d1,d2,turb,i,word,path)
...
max_y = 300.5
mae= mean_absolute_error(yx, yy)
print("Ramp All NMAE=",100*mae/max_y)

mae= mean_absolute_error(yhat, yall)
print("All NMAE=",100*mae/max_y)
