...
def get_all(option):
    ...
    r1, p1 = data_pack(q1,q2,d1,d2,turb,option,L) 
    ...
    r2, p2 = data_pack(q1,q2,d1,d2,turb,option,L)     
    
    r1=r1+r2
    p1=p1+p2
    
    p1 = np.squeeze(p1)
    mae= mean_absolute_error(r1,p1)
    print("\n All NMAE=",100*mae/300.5)
    # print(r1.shape)
    # print(p1.shape)
...
def get_combine(option):
    ...
    value = 100
    for j in range(1,11):
        r2, p2 = data_pack(q,q3,d,d3,'mit',option,L2,j) 
        for i in range(1,11):
            r1, p1 = data_pack(q1,q2,d1,d2,'ge',option,L,i) 
    ...
    print("\n option="+str(option)+" All NMAE=",100*value/300.5)
    print("mit index ="+str(j2))
    print("ge index ="+str(i2))
    # print(r1.shape)
    # print(p1.shape)    
...
def main():
    ...
    # for i in range(1,11):
        # data_pack(q1,q2,d1,d2,turb,option,L,i) 
    # get_all(6)
